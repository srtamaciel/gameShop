...
export class ShopDetailsComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private shopDataService: ShopDataService, private modalService: BsModalService) {}
  ...
  this.shopDataDetailsSubscription = this.shopDataService.getShopDetails(this.shopId).subscribe({
  ...
  openModal(gameId: number) {
    ...
    const modalRef: BsModalRef = this.modalService.show(GameModalComponent, { initialState, class: 'modal-lg'});
  }
